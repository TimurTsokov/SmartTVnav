        ...
        return (
            <div className='header'>
                ...
                >
                    ...
                    <HeaderItem menuItem="search" menuActive={this.changeActive} currentItem = {tab} changeMenuItem = {this.props.changePath} selectedItem={this.props.selectedItem}>
                    ...
                    <HeaderItem menuItem="main" menuActive={this.changeActive} currentItem = {tab} changeMenuItem = {this.props.changePath}>

                        Главная

                    </HeaderItem>
                    <HeaderItem menuItem="newcinema" menuActive={this.changeActive} currentItem = {tab} changeMenuItem = {this.props.changePath}>

                        Новинки

                    </HeaderItem>
                    <HeaderItem menuItem="cinema" menuActive={this.changeActive} currentItem = {tab} changeMenuItem = {this.props.changePath}>

                        Кинозал

                    </HeaderItem>
                    <HeaderItem menuItem="tv" menuActive={this.changeActive} currentItem = {tab} changeMenuItem = {this.props.changePath}>
